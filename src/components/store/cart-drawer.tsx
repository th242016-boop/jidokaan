                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          ...
                          {item.optionLabel ? (
                            ...
                            <p className="text-xs text-subtle">{item.size} mm</p>
                          ) : null}
                          {swatches.length > 0 ? (
                        ...
                        <button
                          ...
                          onClick={() =>
                            removeFromCart(item.productId, item.size, item.optionKey)
                          }
                      ...
                      <div className="flex items-center gap-2">
                        <div className="inline-flex items-center rounded-full border border-border bg-surface">
                          <button
                            ...
                            onClick={() =>
                              setQty(item.productId, item.qty - 1, item.size, item.optionKey)
                            }
                            aria-label="Decrease"
                          >
